class Trophy {
  ...
  checkTrophies(player) {
    ...
    if (player.challenge.cleared.includes(238) || player.challenge.cleared.length >= 100) this.trophies[3] = true;
    ...
    if (player.challenge.cleared.includes(128)) this.smallTrophies1st[26] = true;
    if (player.challenge.cleared.includes(64)) this.smallTrophies1st[27] = true;
    if (player.challenge.cleared.includes(32)) this.smallTrophies1st[28] = true;
    if (player.challenge.cleared.includes(16)) this.smallTrophies1st[29] = true;
    if (player.challenge.cleared.includes(8)) this.smallTrophies1st[30] = true;
    if (player.challenge.cleared.includes(4)) this.smallTrophies1st[31] = true;
    if (player.challenge.cleared.includes(2)) this.smallTrophies1st[32] = true;
    if (player.challenge.cleared.includes(1)) this.smallTrophies1st[33] = true;
    if (player.challenge.cleared.length >= 32) this.smallTrophies1st[34] = true;
    if (player.challenge.cleared.length >= 64) this.smallTrophies1st[35] = true;
    if (player.challenge.cleared.length >= 96) this.smallTrophies1st[36] = true;
    if (player.challenge.cleared.length >= 128) this.smallTrophies1st[37] = true;
    if (player.challenge.cleared.length >= 160) this.smallTrophies1st[38] = true;
    if (player.challenge.cleared.length >= 192) this.smallTrophies1st[39] = true;
    if (player.challenge.cleared.length >= 224) this.smallTrophies1st[40] = true;
    if (player.challenge.cleared.length >= 255) this.smallTrophies1st[41] = true;
    ...
    if (player.challenge.rankCleared.length >= 32) this.smallTrophies1st[68] = true;
    if (player.challenge.rankCleared.length >= 64) this.smallTrophies1st[69] = true;
    if (player.challenge.rankCleared.length >= 96) this.smallTrophies1st[70] = true;
    if (player.challenge.rankCleared.length >= 128) this.smallTrophies1st[71] = true;
    if (player.challenge.rankCleared.length >= 160) this.smallTrophies1st[72] = true;
    if (player.challenge.rankCleared.length >= 192) this.smallTrophies1st[73] = true;
    if (player.challenge.rankCleared.length >= 224) this.smallTrophies1st[74] = true;
    if (player.challenge.rankCleared.length >= 255) this.smallTrophies1st[75] = true;
    ...
    if (player.crownResetTime.gt(0)) {
      ...
      if (player.markStone.stones[2] >= 1) this.smallTrophies2nd[65] = true;
      if (player.markStone.stones[2] >= 100) this.smallTrophies2nd[66] = true;
      if (player.markStone.stones[2] >= 10000) this.smallTrophies2nd[67] = true;
      if (player.markStone.stones[3] >= 1) this.smallTrophies2nd[68] = true;
      if (player.markStone.stones[3] >= 100) this.smallTrophies2nd[69] = true;
      if (player.markStone.stones[3] >= 10000) this.smallTrophies2nd[70] = true;
      if (player.markStone.greatStones[0] >= 1) this.smallTrophies2nd[71] = true;
      if (player.markStone.greatStones[0] >= 10) this.smallTrophies2nd[72] = true;
    }
    this.countSmallTrophies();
  }
