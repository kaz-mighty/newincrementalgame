function Storagedata() {
    ...
    this.dataload = function (data) {
        ...
        for (let i = 0; i < worldnum; i++) {
            ...
            while (saveData.spiritboughtcurrentcrown.length < data.spiritdata.spiritnuma) {
    ...
    this.load = function (data, world) {
        ...
        if (!data.player.onchallenge || data.player.challengebonuses.includes(4)) data.activechallengebonuses = data.player.challengebonuses
